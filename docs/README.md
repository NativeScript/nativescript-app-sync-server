...
```shell
$ git clone https://github.com/EddyVerbruggen/code-push-server
$ cd code-push-server
$ npm i
```
...
save the file [config.js](https://github.com/EddyVerbruggen/code-push-server/blob/master/config/config.js)
...
save the file [process.json](https://github.com/EddyVerbruggen/code-push-server/blob/master/docs/process.json)
...
## Use [CodePush Web](https://github.com/EddyVerbruggen/code-push-web) to manage apps
